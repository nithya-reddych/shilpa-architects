...
const NitWarangal = () => {
  ...
  const parallaxImageUrl = '/assets/nit02.jpeg';
    ...
    <>
      <div className={styles.container}>
        ...
        <div className={styles.section}>
          <img src="/assets/nit03.jpeg" alt="Project Image 1" />
        ...
        <div className={styles.section}>
          ...
          <img src="/assets/nit04.jpeg" alt="Project Image 2" />
        </div>
